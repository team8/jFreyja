...
public class Ports {
	...
	public static final int PORT_ARM_SOLENOID_A = 6;
	public static final int PORT_ARM_SOLENOID_B = 7;
	...
	public static final int PORT_LIFTER_HALL_EFFECT_TOP = 4;
	public static final int PORT_LIFTER_HALL_EFFECT_BOTTOM = 5;
